      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        <div className="grid gap-12 lg:grid-cols-2 items-start">
          ...
          <div className="flex flex-col gap-7 lg:pt-4">
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-3 divide-x divide-white/[0.06]">
                {stats.map((stat, i) => {
                  const count = useCountUp(stat.value, 1100, isInView);
                  return (
                    <motion.div
                      key={stat.label}
                    ...
                    >
                      ...
                      <span className="text-[10px] uppercase tracking-[0.22em] text-white/25 font-medium">
                        {stat.label}
                      </span>
                    </motion.div>
                  );

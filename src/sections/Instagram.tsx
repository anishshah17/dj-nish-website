      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          <div className="mb-4 flex items-center justify-center gap-3">
            ...
            <span className="text-xs uppercase tracking-[0.3em] text-muted font-display font-bold">Follow</span>
        ...
        >
          ...
          <div className="w-full">
            ...
            <div className="elfsight-app-8e3b5c9a-9a1e-4b7e-8c5d-3e2f1a9b8c7d" data-elfsight-app-lazy></div>
          </div>

          {/* Fallback content if embed doesn't load */}
          <noscript>
            <div className="flex items-center justify-center p-8 md:p-12 min-h-[500px]">
              <div className="text-center">
                ...
                <h3 className="text-xl md:text-2xl font-display font-bold mb-2">@djnish.chi</h3>
                <p className="text-muted text-sm md:text-base mb-6">
                  Follow for the latest updates and behind-the-scenes content.
                </p>
                <a
                  href="https://instagram.com/djnish.chi"
                  target="_blank"
